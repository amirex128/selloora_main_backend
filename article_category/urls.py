...
from .views import ArticleCategoryIndex, ArticleCategoryCreate, ArticleCategoryShow, ArticleCategoryUpdate, ArticleCategorySoftDelete, \
    ArticleCategoryForceDelete, ArticleCategoryRestore
